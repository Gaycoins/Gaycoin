...
!define COMPANY "Gaycoin project"
!define URL http://www.gaycoin.eu/
...
!define MUI_FINISHPAGE_RUN $INSTDIR\gaycoin-qt.exe
...
OutFile gaycoin-0.7.9-win32-setup.exe
InstallDir $PROGRAMFILES\Litecoin
CRCCheck on
XPStyle on
BrandingText " "
ShowInstDetails show
VIProductVersion 0.7.9.0
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File ../release/gaycoin-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/gaycoind.exe
    ...
    Delete /REBOOTOK $INSTDIR\gaycoin.exe
...
Section -post SEC0001
    ...
    WriteRegStr HKCR "litecoin\DefaultIcon" "" $INSTDIR\gaycoin-qt.exe
    WriteRegStr HKCR "litecoin\shell\open\command" "" '"$INSTDIR\gaycoin-qt.exe" "$$1"'
SectionEnd
